...
export class GameInfoComponent implements OnInit, OnChanges {
  ...
  ngOnChanges(): void {
    if (this.card) {
      // nur ausführen wenn Card bereits existiert
  ...
  cardAction = [
    ...
    },
    {
      title: 'Thumbmaster',
      description:
        'The Thumbmaster can place their thumb on the table at any time. Everyone else must follow. The last player to do so drinks.',
    },
    { title: 'Men', description: 'All men drink.' },
    {
      title: 'Quizmaster',
      description:
        'The Quizmaster can ask questions at any time. Anyone who answers incorrectly must drink.',
    },
    {
